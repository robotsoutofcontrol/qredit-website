...
$(document).ready(function () {
	...
	var csvfile_import_122860 = "https://docs.google.com/spreadsheets/d/1weUHqRBDdiY3RNzAA1eD95uIqcAhl1BTb4iBinamKnw/gviz/tq?tqx=out:csv&sheet=status".replace(/\&amp\;/g, '&');
	$('.122860 .databaseTable_import_wrap').CSVToTable(csvfile_import_122860, { loadingText: 'Generating Table', loadingImage: 'https://qredit.io/assets/img/loading.gif', startLine: 0, tableClass: "databaseTable_import", theadClass: "heading" }).bind("loadComplete", function () {
